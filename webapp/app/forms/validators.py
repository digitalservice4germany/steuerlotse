...
class ValidDateOf:
    # Validate a date between 01.01.1900 and today
    # Possible validation errors:
    # - Date is invalid (99.99.2021)
    # - Date is incomplete (__.__.2021)
    # - Date is in the future
    # - Date is is before 01.01.1990
    
    def __init__(self, message_incomplete, message_incorrect, message_in_the_future, message_to_far_in_past) -> None:
...
class ValidDateOfBirth(ValidDateOf):
    def __init__(self) -> None:
        super().__init__(message_incomplete = _('validate.date-of-birth-incomplete'), 
            message_incorrect = _('validate.date-of-incorrect'), 
            message_in_the_future = _('validate.date-of-in-the-future'), 
            message_to_far_in_past = _('validate.date-of-to-far-in-past'))
class ValidDateOfDeath(ValidDateOf):
    def __init__(self) -> None:
        super().__init__(message_incomplete = _('validate.date-of-death-incomplete'), 
            message_incorrect = _('validate.date-of-incorrect'), 
            message_in_the_future = _('validate.date-of-in-the-future'), 
            message_to_far_in_past = _('validate.date-of-to-far-in-past'))
...
class ValidDateOfMarriage(ValidDateOf):
    def __init__(self) -> None:
        super().__init__(message_incomplete = _('validate.date-of-marriage-incomplete'), 
            message_incorrect = _('validate.date-of-incorrect'), 
            message_in_the_future = _('validate.date-of-in-the-future'), 
            message_to_far_in_past = _('validate.date-of-to-far-in-past'))
...
class ValidDateOfDivorce(ValidDateOf):
    def __init__(self) -> None:
        super().__init__(message_incomplete = _('validate.date-of-incomplete'), 
            message_incorrect = _('validate.date-of-incorrect'), 
            message_in_the_future = _('validate.date-of-in-the-future'), 
            message_to_far_in_past = _('validate.date-of-to-far-in-past'))