                  ...
                  if (b || g) {
                    if (
                      (!b || (g && c.newPos < p.newPos)
                        ? ((a = r(p)),
                          o.pushComponent(a.components, void 0, !0))
                        : ((a = c).newPos++,
                          o.pushComponent(a.components, !0, void 0)),
      ...
      276: (e, t, n) => {
        ...
        function f(e, t, n, i, r) {
          ...
          if ("[object Array]" === s.call(e)) {
            for (
              t.push(e), l = new Array(e.length), n.push(l), a = 0;
              a < e.length;
              a += 1
            )
              l[a] = f(e[a], t, n, i, r);
        ...
        (t.jsonDiff = l),
          ...
          (l.castInput = function (e) {
            ...
            return "string" == typeof e
              ? e
              : JSON.stringify(f(e, null, null, r), r, "  ");
          }),
                ...
                if (((t.lines = i), t.added || t.removed)) {
                  ...
                  if (!d) {
                    ...
                    (d = b),
                      ...
                      s &&
                        ((h =
                          l.context > 0 ? u(s.lines.slice(-l.context)) : []),
                        (d -= h.length),
                        (p -= h.length));
                  }
                  (o = h).push.apply(
                    ...
                    t.added ? (g += i.length) : (b += i.length);
                } else {
                  if (d)
                    if (i.length <= 2 * l.context && e < f.length - 2) {
                      var v;
                      (v = h).push.apply(v, r(u(i)));
                    } else {
                      var m,
                        y = Math.min(i.length, l.context);
                      (m = h).push.apply(m, r(u(i.slice(0, y))));
                      var w = {
                        oldStart: d,
                        oldLines: b - d + y,
                        newStart: p,
                      ...
                      if (e >= f.length - 2 && i.length <= l.context) {
                        var L = /\n$/.test(n),
                          S = /\n$/.test(a),
                          x = 0 == i.length && h.length > w.oldLines;
                        !L &&
                          x &&
                          n.length > 0 &&
                          h.splice(
      ...
      51: (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.merge = function (e, t, n) {
            ...
            for (
              var r = 0, a = 0, o = 0, s = 0;
              r < e.hunks.length || a < t.hunks.length;

            ) {
              var l = e.hunks[r] || { oldStart: 1 / 0 },
                b = t.hunks[a] || { oldStart: 1 / 0 };
              if (d(l, b))
                i.hunks.push(p(l, o)), r++, (s += l.newLines - l.oldLines);
              else if (d(b, l))
                i.hunks.push(p(b, s)), a++, (o += b.newLines - b.oldLines);
              else {
                var g = {
                ...
                h(g, l.oldStart, l.lines, b.oldStart, b.lines),
                  a++,
                  r++,
                  i.hunks.push(g);
              }
        ...
        function h(e, t, n, i, r) {
          ...
          for (
            m(e, a, s), m(e, s, a);
            a.index < a.lines.length && s.index < s.lines.length;
        ...
        function g(e, t, n, i) {
          ...
          s.merged
            ? (r = e.lines).push.apply(r, o(s.merged))
            : v(e, i ? s : a, i ? a : s);
        }
        function v(e, t, n) {
            ...
            function o() {
              ...
              for (s(e), s(e), e.hunks = []; a < n.length; ) {
                ...
                if (/^@@/.test(f)) e.hunks.push(l());
                  ...
                  if (f && t.strict)
                    throw new Error(
                      "Unknown line " + (a + 1) + " " + JSON.stringify(f)
                    );
                  a++;
                }
              }
        ...
        !(function (e) {
          ...
          (e.tags = {
            ...
            (e.scan = function (n, i) {
              ...
              function m() {
                c.length > 0 &&
                  (d.push({ tag: "_t", text: new String(c) }), (c = ""));
              }
              function y(n, i) {
                if (
                  (m(),
          ...
          function c(t, n, i, r) {
            ...
            for (a = i[i.length - 1]; t.length > 0; ) {
              ...
              if (e.tags[l.tag] <= e.tags.$ || d(l, r))
                i.push(l), (l.nodes = c(t, l.tag, i, r));
              else {
                if ("/" == l.tag) {
                  if (0 === i.length)
            ...
            (e.Template.prototype = {
              ...
              ep: function (e, t) {
                ...
                if (((this.partials[e].base = i), n.subs)) {
                  ...
                  i = (function (e, t, n, i, r, a) {
                    ...
                    for (l in ((r = r || {}), (f.stackPartials = r), n))
                      r[l] || (r[l] = n[l]);
              ...
              d: function (e, n, i, r) {
                ...
                return (
                  ...
                  (r ||
                    "function" != typeof s ||
                    (n.push(u), (s = this.mv(s, n, i)), n.pop()),
                  s)
                );
              },
              f: function (e, n, i, r) {
                ...
                return o
                  ? (r || "function" != typeof a || (a = this.mv(a, n, i)), a)
                  : !r && "";
              },
              ...
              if (e && !e.startsWith("*")) {
                ...
                if (e.startsWith("diff")) {
                  if (
                    (I(),
                    (D =
                      /^diff --git "?([a-ciow]\/.+)"? "?([a-ciow]\/.+)"?/.exec(
                        e
                      )) &&
                      ((d = f(D[1], void 0, t.dstPrefix)),
                      (p = f(D[2], void 0, t.srcPrefix))),
                    null === i)
                  )
                  ...
                  if (
                    ...
                    if (
                      ...
                      return (
                        (i.oldName = D),
                        void (i.language = o(i.oldName, i.language))
                      );
                    if (
                      i &&
                      !i.newName &&
                      ...
                      return (
                        (i.newName = D),
                        void (i.language = o(i.newName, i.language))
                      );
                  }
                  if (
                    i &&
                    (e.startsWith(g) ||
                      (i.isGitDiff && i.oldName && i.newName && !a))
                  )
                    A(e);
                  else if (
                    a &&
      ...
      834: function (e, t, n) {
        ...
        (t.defaultDiff2HtmlConfig = i(
          i(
            ...
            c.defaultSideBySideRendererConfig
          ),
          ...
          (t.parse = function (e, n) {
            return (
              void 0 === n && (n = {}),
              l.parse(e, i(i({}, t.defaultDiff2HtmlConfig), n))
            );
          }),
          (t.html = function (e, n) {
            void 0 === n && (n = {});
            ...
            return (
              ...
              (e.prototype.render = function (e, t, n, i, r) {
                ...
                try {
                  ...
                  throw new Error(
                    "Could not find template to render '".concat(a, "'")
                  );
                }
              }),
      ...
      741: function (e, t, n) {
        ...
        function v(e, t, n) {
          ...
          return {
            ...
            content: n ? g(e.substring(i)) : e.substring(i),
          };
        }
        function m(e) {
            ...
            return (
              ...
              (e.prototype.generateFileHtml = function (e) {
                ...
                return e.blocks
                  .map(function (i) {
                    var r = {
                      left: t.makeHeaderHtml(i.header, e),
                      right: t.makeHeaderHtml(""),
                    };
                    return (
                      t.applyLineGroupping(i).forEach(function (i) {
                        var a = i[0],
              ...
              (e.prototype.generateSingleHtml = function (e) {
                ...
                return this.hoganUtils.render(u, "line", {
                  ...
                  lineClass:
                    void 0 !== e
                      ? t
                      : "".concat(t, " d2h-code-side-emptyplaceholder"),
                  contentClass:
                    void 0 !== e
                      ? n
                      : "".concat(n, " d2h-code-side-emptyplaceholder"),
                  prefix:
