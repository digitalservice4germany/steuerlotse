...
class TestUnlockCodeActivationGetSessionData:
    ...
    def test_if_get_storage_data_called_then_get_cookie_data_function_called_with_correct_params(self, unlock_code_request_flow):
        with patch('app.data_access.storage.cookie_storage.CookieStorage.get_data') as patched_get_cookie_data:
            unlock_code_request_flow._get_storage_data(ttl=2)
