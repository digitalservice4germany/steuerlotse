...
from erica.elster_xml.xml_parsing.erica_xml_parsing import remove_declaration_and_namespace, get_elements_text_from_xml, get_elements_key_value_from_xml
from erica.elster_xml.xml_parsing.elster_specifics_xml_parsing import get_antrag_id_from_xml, get_idnr_from_xml, \
